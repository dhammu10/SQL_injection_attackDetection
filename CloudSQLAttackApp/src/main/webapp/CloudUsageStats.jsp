...
<html>
    ...
    <table width="950" cellspacing="0" border="1" cellpadding="7" align="center" class="table table-bordered tblform">
        ...
        String cmonth=request.getParameter("cmbmon");
          ...
          vt=sf.getValue("select userid,collegeName from colleges  ", 1);
          ...
          rent.clear();
          rent=obj.getRent();
          Vector vnm=sf.getValue("select collegeName from colleges where userid='"+vt.elementAt(i).toString()+"'", 1);
        %>
