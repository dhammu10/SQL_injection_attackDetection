...
function makeGetRequest4(st) {
	// alert('in makeget3'+st);
     //subId=document.frm.subId.value;
    // semester=document.frm.semester.value;
    // branch=document.frm.branchname.value;
     //alert(courseId+" sem="+semester+" branch="+branch);
    http.open('get', 'ShowQuestions111?unitId=' + st);
...
function makeGetRequestQuesType(st) {
	// alert('in makeget3'+st);
     //subId=document.frm.subId.value;
    // semester=document.frm.semester.value;
    // branch=document.frm.branchname.value;
     //alert(courseId+" sem="+semester+" branch="+branch);
    http.open('get', 'ShowDefine.jsp?quesId=' + st);
    http.onreadystatechange = processResponseQType;
    http.send(null);
}

function processResponseQType() {
    if(http.readyState == 4){
        var response = http.responseText;
        document.getElementById('define').innerHTML = response;
    }
}
...
<h2> Answer Registration</h2>
<form name="frm" id="frm" method="post" action="AnsReg">
<table class="tblform">
	<!-- <tr>
		<td>Branch ID</td>
	...
	<tr>
		<td>Model Answer</td>
		<td>
		<div id="define" name="define"></div>
		<textarea name="ans" cols="10" rows="30" class="form-control" required></textarea>
