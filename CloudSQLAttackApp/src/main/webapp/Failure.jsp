...
else if(request.getAttribute("activity").toString().trim().equals("SubmitAns"))
{
%>
	SQL Attack Detected and Prevented!!
<%
}
else if(request.getAttribute("activity").toString().trim().equals("SQLAttack"))
{
%>
	SQL Attack Detected and Prevented!!
<%
...
<%
 ...
 if(request.getAttribute("activity").toString().trim().equals("SQLAttack"))
{
%>
	<h1>SQL Attack Detected and Prevented!!</h1>
