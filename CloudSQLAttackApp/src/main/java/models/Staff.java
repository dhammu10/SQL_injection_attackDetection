...
public class Staff {
	...
	private String dob;
	private String branch,collegeid;
...
public List<Staff> getStaffList(){
	...
	try {
		...
		rs=st.executeQuery("select * from staffpersonal where collegeid='"+collegeid+"'");
