...
public class ViewStudentList {
	...
	private String userstatus,collegeid;
	...
	public List<ViewStudentList> getapprovalList(){
		...
		try {
			...
			rs=st.executeQuery("select userid,usernm,userstatus,usertype from users where userstatus='deactive' and collegeid='"+collegeid+"' and (usertype='student'  or usertype='exstudent')");
