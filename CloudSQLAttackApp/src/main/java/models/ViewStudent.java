...
public class ViewStudent {
	...
	private String userid,course,collegeid;
	...
	public List<ViewStudent> getStudentReport(){
		...
		rs=st.executeQuery("select * from studentpersonal where collegeid='"+collegeid+"' and usertype='student' or usertype='exstudent'");
		ViewStudent vs;
