...
print("<html>")
print("<head>")
print("<meta http-equiv='refresh' content='0;url=http://localhost:8080/FromPythonQues?sts="+param+"&userid="+userid+"&result="+result+"&id="+id+"'/>")
